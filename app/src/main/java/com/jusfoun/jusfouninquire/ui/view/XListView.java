...
public class XListView extends ListView implements OnScrollListener {
    ...
    private boolean isInterceptTouchEvent = false;//是否拦截子view事件
    ...
    private SwipeRightMenuLayout swipeRightMenuLayout;

    public void setSwipeRightMenuLayout(SwipeRightMenuLayout swipeRightMenuLayout) {
        this.swipeRightMenuLayout = swipeRightMenuLayout;
    }
            ...
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    if (open == -1) {
                        ...
                        if (view instanceof SwipeRightMenuLayout)
                            open=position;
                    ...
                    if (position != open) {
                        for (int i = 0; i < getCount(); i++) {
                            ...
                            if (view instanceof SwipeRightMenuLayout) {
                                if (((SwipeRightMenuLayout) view).isRightMenuOpen())
                                    ((SwipeRightMenuLayout) view).onClose();
                            }
                        }
                        return true;
                    }else {
