...
public class RollPagerView extends RelativeLayout implements ViewPager.OnPageChangeListener {
	...
	private void initView(AttributeSet attrs) {
		if (mViewPager != null) {
			...
			paddingBottom = (int) type.getDimension(R.styleable.RollViewPager_rollviewpager_hint_paddingBottom, PhoneUtil.dip2px(getContext(), 4));
	...
	public void onPageSelected(int arg0) {
		//统计手动滑动的友盟事件
		if ((System.currentTimeMillis()- mRecentTouchTime) < delay){
			EventUtils.event(mContext,EventUtils.HOME13);
		}
