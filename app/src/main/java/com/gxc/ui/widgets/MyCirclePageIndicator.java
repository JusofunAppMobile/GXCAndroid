...
/**
 * @author liuguangdan
 * @version create at 2019/1/8/008 11:45
 * @Email lgd@jusfoun.com
 * @Description ${}
 */
public class MyCirclePageIndicator extends View implements PageIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final float threeRadius = mRadius * pointPadding;
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        public static final Parcelable.Creator<MyCirclePageIndicator.SavedState> CREATOR = new Parcelable.Creator<MyCirclePageIndicator.SavedState>() {
            @Override
            public MyCirclePageIndicator.SavedState createFromParcel(Parcel in) {
                return new MyCirclePageIndicator.SavedState(in);
            }

            @Override
            public MyCirclePageIndicator.SavedState[] newArray(int size) {
                return new MyCirclePageIndicator.SavedState[size];
            }
        };
    }

    public void setPointPadding(int padding) {
